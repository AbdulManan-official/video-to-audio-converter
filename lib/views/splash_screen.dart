...
//   runApp(
//     DevicePreview(
//       enabled: !kReleaseMode,   // Debug mode = ON, Release mode = OFF
...
//       ),
//
//       /// 🔥 Add this builder (IMPORTANT)
//       builder: (context, child) {
//         final mq = MediaQuery.of(context);
//
//         return MediaQuery(
//           data: mq.copyWith(textScaleFactor: 1.0), // ⛔ system scaling disabled
//           child: DevicePreview.appBuilder(context, child), // keep your device preview
//         );
//       },
//
